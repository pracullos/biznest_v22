...
import type {
  ...
  HTTPValidationError,
  ListZoningAreasCitiesCityIdZoningGetParams,
  ZoningAreaCreate,
...
export const listZoningAreasCitiesCityIdZoningGet = (
    cityId: string,
    params?: ListZoningAreasCitiesCityIdZoningGetParams, options?: AxiosRequestConfig
...
export const getListZoningAreasCitiesCityIdZoningGetQueryKey = (cityId: string,
    params?: ListZoningAreasCitiesCityIdZoningGetParams,) => {
    return [
    `/cities/${cityId}/zoning`, ...(params ? [params] : [])
    ] as const;
    }


export const getListZoningAreasCitiesCityIdZoningGetQueryOptions = <TData = Awaited<ReturnType<typeof listZoningAreasCitiesCityIdZoningGet>>, TError = AxiosError<HTTPValidationError>>(cityId: string,
    params?: ListZoningAreasCitiesCityIdZoningGetParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listZoningAreasCitiesCityIdZoningGet>>, TError, TData>, axios?: AxiosRequestConfig}
) => {

const {query: queryOptions, axios: axiosOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListZoningAreasCitiesCityIdZoningGetQueryKey(cityId,params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listZoningAreasCitiesCityIdZoningGet>>> = ({ signal }) => listZoningAreasCitiesCityIdZoningGet(cityId,params, { signal, ...axiosOptions });
...
export function useListZoningAreasCitiesCityIdZoningGet<TData = Awaited<ReturnType<typeof listZoningAreasCitiesCityIdZoningGet>>, TError = AxiosError<HTTPValidationError>>(
 cityId: string,
  ...
  const queryOptions = getListZoningAreasCitiesCityIdZoningGetQueryOptions(cityId,params,options)
